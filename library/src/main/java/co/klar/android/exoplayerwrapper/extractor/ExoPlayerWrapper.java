...
public class ExoPlayerWrapper implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param wrapper The player for which renderers are being built. {@link ExoPlayerWrapper#onRenderers}
         *                should be invoked once the renderers have been built. If building fails,
         *                {@link ExoPlayerWrapper#onRenderersError} should be invoked.
         */
        void buildRenderers(ExoPlayerWrapper wrapper);
     ...
     */
    protected void onRenderersError(Exception e) {
    ...
    protected Looper getPlaybackLooper() {
    ...
    private void pushTrackSelection(boolean blockForSurfacePush) {
        if (videoRenderer == null) {
            return;
        }
